...
echo "<a href='index.php?page=add_notice' ><h3 style='color:red' align='center'>Add New notice</h3></a>";
}
else
{
?>
...
<br/>
<br/>
<a href="index.php?page=add_notice" ><h3 style="color:red" align="center">Add New notice</h3></a>
